...
<html>
    <head>
        ...
        <title> pharmacists log in</title>
    ...
    <body>
          <div class="container">
			...
			<section class="main">
				...
				<form class="form-4" action="/Novant_health/phAuthenticate">
				    <h1>Pharmacists Login</h1>
				    <p>
				    ...
				    <p>
				        <input type="submit" name="submit" value="Continue">
                                     ...
                                     <a href="phregis.jsp"><font size="4"> <b>New? Register!</b></font>
				</form>
                            </section>
    </div>
                                <%
