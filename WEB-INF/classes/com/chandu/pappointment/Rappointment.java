...
import com.chandu.doctor.doctorbean;
import com.chandu.doctor.doctordaos;
...
out.println("<link rel=\"stylesheet\" href=\"images/calender.css\" type=\"text/css\" />");
            ...
            RequestDispatcher rm=request.getRequestDispatcher("/Design/menu.jsp");
  ...
  out.println("<center><font  color=black size=8><b>Appointment Request</b></font></center>");
   ...
   out.println("<label class=\"desc\" id=\"title0\" for=\"Field0\">image</label>");
           ...
           out.println("<li id=\"foli12\" class=\"notranslate \">");
           out.println("<label class=\"desc\" id=\"title36\" for=\"Field36\">Doctors</label>");
           out.println("<span\">");
