    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           if( (users==null) && (pass==null)){
            ...
            out.println("{");
            out.println("var a=confirm(\"Are you sure you want to delete It\")");
            out.println("if(a)");
            out.println("{");
...
out.println("<form name=\"thisform\">");
           ...
           out.println("<input name=\"opn\" type=\"hidden\">");
                    ...
                    out.println("<tr bgcolor=\"orange\"><th>Medicine Name</th><th>Price</th><th>Stock in Hand</th><th>DangerLevel</th><th>Edit</th><th>Delete</th></tr>");
                    ...
                    out.println("<tr><td>"+c.getPname()+"</td>"
                            ...
                            + "<td>"+c.getP_price()+"</td>"
                            + "<td>"+c.getStockinhand()+"</td>"
                            + "<td>"+c.getDangerlevel()+"</td>"
                           
                            + "<td><a href=\"edit?id="+c.getPid()+"\">Edit</a></td>"
                            + "<td><a onclick=\"aaa("+c.getPid()+")\">Delete</a></td></tr>");
                }
